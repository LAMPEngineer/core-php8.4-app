...
function processPayment(PaymentMethod $paymemt, float $amoun)
{
    echo $paymemt->pay($amoun) . PHP_EOL;
}

function processRefund(RefundablePaymentMethod $payment, float $amoun)
{
